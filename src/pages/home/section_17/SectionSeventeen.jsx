...
export default function SectionSeventeen(){
    ...
    const coheteContainerRef = useRef(null);
  
    const subirCohete = () => {
      let cohete = coheteRef.current;
      let form = formRef.current;
      let coheteContianer = coheteContainerRef.current;
            ...
            <div class="container">
                <div class="row d-flex justify-content-center">
                    <div class="col-md-10 d-flex flex-column align-items-center align-self-end">
                        <h3 class="text-center mb-5">¿Listo para evolucionar en la jungla digital?</h3>
                        <button onClick="subirCohete()" class="mb-5 btn-power btn">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="132" height="132" viewBox="0 0 132 132" class="start">
                                <defs>
                                ...
                                <g id="Grupo_5823" data-name="Grupo 5823" transform="translate(-892 -8571)">
                                    ...
                                    <path class="color" id="Trazado_12260" data-name="Trazado 12260" d="M363.995,49.991A49.991,49.991,0,1,1,314,0a49.991,49.991,0,0,1,49.991,49.99" transform="translate(628.678 8646.999)" fill="#fddb00"/>
                ...
                <div class="container-form-cohete2" style="overflow:hidden  ">
                    ...
                    <div class="container-cohete-form" ref={coheteContainerRef}>
            
                        <div class="col-md-12 d-flex flex-column align-items-center cohete-form-container">
                            <dotlottie-player id="cohete-form" ref={coheteRef} autoplay loop  mode="normal" src="assets/img/lotties/cohete.lottie" background="transparent" speed="1" style="width: 910px; height: auto;z-index:1;" class="rocket"></dotlottie-player>
                        </div>
                        <div class="row d-flex justify-content-center content-form" ref={formRef} id="form-contact">
                            <div class="col-md-8 bg-form">
                                <div class="d-none d-md-flex align-items-baseline justify-content-center">
                                    <img loading="lazy" width="19.738" height="19.733" src="assets/img/icon-arrow-form.svg" />
                                    <h3 class="fc-darkBlue-01 fs-32 text-center ms-2">Dejanos tu mensaje o inquietud</h3>
                                </div>
                                <p
                                    class="fs-18 ff-circularBook fc-darkBlue-01 text-center mb-4 mt-0 mt-md-3 mt-md-0 d-none d-md-block">
                                ...
                                <div class="d-none d-md-flex justify-content-center mb-4">
                                    <a href="mailto:contacto@chimpancedigital.com.ar">
                                        ...
                                        <svg class="mx-3" xmlns="http://www.w3.org/2000/svg" width="23.33" height="17.376" viewBox="0 0 23.33 17.376" style="vertical-align: sub;">
                                            ...
                                            <p class="fc-darkBlue-01 mb-0">contacto@chimpancedigital.com.ar</p>
                                        </div>
                                    </a>
                                
                                    <a target="_blank" class="d-block d-md-none" href="https://api.whatsapp.com/send?phone=+5493516503470&amp;text=Buenos%20días,%20quiero%20mas%20info%20sobre%20desarrollo%20web">
                                        <div class="d-flex ms-4">
                                            <img loading="lazy" src="assets/img/icon-phone-form.svg" width="21.847" height="21.839" class="me-3" />
                                            <p class="fc-darkBlue-01 mb-0">351 650-3470</p>
                                        </div>
                                    </a>
                                    <a target="_blank" class="d-none d-md-block" href="https://web.whatsapp.com/send?phone=+5493516503470&amp;text=Buenos%20días,%20quiero%20mas%20info%20sobre%20desarrollo%20web">
                                        <div class="d-flex ms-4">
                                            <img alt="icon-phone" src="assets/img/icon-phone-form.svg" width="21.847" height="21.839" class="me-3" />
                                            <p class="fc-darkBlue-01 mb-0">351 650-3470</p>
                                        </div>
                                    </a>
                                </div>
                                <div class="bg-form-input">
                                    <form action="" id="form-cohete" method="post" style="height:auto;">
                                        ...
                                        <div class="input-group input-group-lg mb-4 position-relative">
                                            <span class="input-group-text d-block d-md-none" id="basic-addon1">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="15.089" height="19.545" viewBox="0 0 15.089 19.545" style="vertical-align: sub;">
                                        ...
                                        <div class="input-group input-group-lg mb-4 position-relative">
                                            <span class="input-group-text d-block d-md-none" id="basic-addon1">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="23.33" height="17.376" viewBox="0 0 23.33 17.376" style="vertical-align: sub;">
                                                    <path id="envelope-line" d="M23.872,6H3.458A1.453,1.453,0,0,0,2,7.448V21.929a1.453,1.453,0,0,0,1.458,1.448H23.872a1.453,1.453,0,0,0,1.458-1.448V7.448A1.453,1.453,0,0,0,23.872,6ZM22.749,21.929H4.668l5.1-5.242L8.722,15.68,3.458,21.089V8.549L12.52,17.5a1.465,1.465,0,0,0,2.056,0l9.3-9.181v12.67l-5.366-5.329-1.028,1.021ZM4.413,7.448H22.691l-9.142,9.029Z" transform="translate(-2 -6)" fill="#0075a9"/>
                                                </svg>
                                            </span>
                                            <input type="mail" class="form-control" id="mail" placeholder="Email" required />
                                        </div>
                                        <div class="input-group input-group-lg mb-4 position-relative">
                                            <span class="input-group-text d-block d-md-none" id="basic-addon1">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="19" height="19.012" viewBox="0 0 19 19.012" style="vertical-align: sub;">
                                                    <defs>
                                                    ...
                                                    <g id="Grupo_5255" data-name="Grupo 5255" transform="translate(-3.358 -2.944)">
                                                        <g id="Grupo_4709" data-name="Grupo 4709" transform="translate(3.358 2.944)" clip-path="url(#clip-path)">
                                    ...
                                    <div id="contact_form" class="d-flex justify-content-center">
